...
/*   Updated: 2024/11/08 13:07:55 by endoliam         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	set_img_data(t_anim *element, int x, int y, int flag)
{
	...
	{
		element->scale_x = SCALE_X * 0.8;
		element->scale_y = SCALE_Y * 1.2;
	}
	element->x = x;
	element->y = y;
}
...
void	set_data_menu(t_data *data)
{
	...
	data->menu.icone.scale_x = SCALE_X;
	data->menu.icone.scale_y = SCALE_Y;
